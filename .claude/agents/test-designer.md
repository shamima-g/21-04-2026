...
7. Add `BA decision required` wherever multiple materially different business outcomes are plausible. Always format these as blockquotes (`>`) so they stand out visually for the BA reviewer.
